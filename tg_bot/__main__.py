...
Hi {}, my name is {}!  It's a cool admin bot that I run by [HE](tg://user?id={}).
 ...
 Mine was built in python3 using the python-telegram-bot library. I am fully opensourced.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🔔 Updates Channel", url="https://t.me/KGN_MOVIES")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/KGN_BOTS_SUPPORT"), InlineKeyboardButton(text="🔔 Bot Channel", url="https://t.me/KGN_BOTS")],
                     [InlineKeyboardButton(text="🎬 Movies Channel", url="https://t.me/KGN_MOVIE"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1870092799 and DONATION_LINK:
